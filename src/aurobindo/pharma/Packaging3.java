 ...
 * @author Venkat
 */
public class Packaging3 extends javax.swing.JFrame {
Connection con;
ResultSet rs;
PreparedStatement pst,pst1;
int c=0,s=0,sum;
Boolean isIt=false;
 String type="Packing3";
    /**
...
isIt = true;
        ...
        try{
         ...
         int e=Integer.parseInt(a1);
          ...
          String sql1="update product set packing_staff3='completed',Quantity9='"+d+"',mfg_date='"+a3+"',exp_date='"+exp+"'where product_id='"+a1+"'"; 
          pst=con.prepareStatement(sql); 
...
jTextField8.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Packaging3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Packaging3().setVisible(true);
            }
        });
    }
