...
public void Search(){
    ...
    String sql="select * from staffdata where Username='"+a1+"'";
    try{
...
public void Retrive(){
    ...
    String sql="select * from staffdata where Answer='"+a2+"'";
    try{
        pst=con.prepareStatement(sql);
        rs=pst.executeQuery();
        if(rs.next()){
   ...
   JOptionPane.showMessageDialog(null, e); 
    ...
    private void initComponents() {
        ...
        jButton3.setIcon(new javax.swing.ImageIcon("E:\\Saveetha Library\\back.png")); // NOI18N
        ...
        jButton2.setIcon(new javax.swing.ImageIcon("E:\\Saveetha Library\\padlock.png")); // NOI18N
