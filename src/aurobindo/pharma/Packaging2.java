 ...
 * @author Venkat
 */
public class Packaging2 extends javax.swing.JFrame {
Connection con;
ResultSet rs;
PreparedStatement pst,pst1;
int c=0,s=0,sum;
Boolean isIt=false;
 String type="Packing2";
    /**
...
public void Search(){
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(0, 0, 255)), "Packing", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 24), new java.awt.Color(255, 0, 51))); // NOI18N
...
isIt = true;
        ...
        try{
         ...
         int e=Integer.parseInt(a1);
          ...
          String sql1="update product set packing_staff2='completed',Quantity8='"+d+"',mfg_date='"+a3+"',exp_date='"+exp+"'where product_id='"+a1+"'";
          pst=con.prepareStatement(sql); 
...
jTextField8.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Packaging2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Packaging2().setVisible(true);
            }
        });
    }
