 ...
 * @author shabaz
 */
public class Blending2 extends javax.swing.JFrame {
Connection con;
ResultSet rs;
PreparedStatement pst,pst1;
int sum=0,c=0,s=0;
 Boolean isIt = false;
 String type="Blending2";
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
         ...
         String sql1="update blending set completed_time='"+su+"',date='"+da+"' where product_id='"+a+"' and blending_type='"+type+"'";
          String sql="update product set blending_staff2='completed' where product_id='"+a+"'";
...
JOptionPane.showMessageDialog(null, "Raw data Added");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Blending2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
